        ...
        <div class="row">
            <div class="col-12 col-md-8">
                <div class="form-group">
                    <label class="control-label col-lg-3 ">
          <span>
            {l s='Authentication' mod='colissimo'}
          </span>
                    </label>
                    <div class="col-lg-9 colissimo-connexion-type-prestashop">
        <span class="switch prestashop-switch">
            <input type="radio"
                   value="0"
                   name="COLISSIMO_CONNEXION_KEY"
                   id="COLISSIMO_CONNEXION_KEY_off"
                   {if !$form_data['COLISSIMO_CONNEXION_KEY']|intval}checked="checked"{/if}>
            <label for="COLISSIMO_CONNEXION_KEY_off">{l s='Colissimo account' mod='colissimo'}</label>
             <input type="radio"
                    value="1"
                    name="COLISSIMO_CONNEXION_KEY"
                    id="COLISSIMO_CONNEXION_KEY_on"
                    {if $form_data['COLISSIMO_CONNEXION_KEY']|intval}checked="checked"{/if}>
            <label for="COLISSIMO_CONNEXION_KEY_on">{l s='Connexion Key' mod='colissimo'}</label>
            <a class="slide-button btn"></a>
          </span>
                    </div>
                    <div class="col-lg-9 col-lg-offset-3"></div>
        ...
        <div class="col-lg-offset-3 colissimo-box">
            <div class="panel">
                <div class="row">
                    ...
                    <div class="colissimo-account-fields">
                        <div class="form-group">
                            <label class="control-label col-lg-3">
              <span class="label-tooltip"
                    data-toggle="tooltip"
              ...
              <span class="label-tooltip"
                ...
                {l s='Password' mod='colissimo'}
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">
                             <span>
                              {l s='Parent account ID' mod='colissimo'}
                             </span>
                            </label>
                            <div class="col-lg-9">
                                <div class="input-group fixed-width-xxl">
                                    <span class="input-group-addon"><i class="icon-user"></i></span>
                                    <input type="text"
                                           name="COLISSIMO_ACCOUNT_PARENT_ID"
                                           class="input fixed-width-xxl"
                                           value="{$form_data['COLISSIMO_ACCOUNT_PARENT_ID']|escape:'htmlall':'UTF-8'}">
                                </div>
                            </div>
                            <div class="col-lg-9 col-lg-offset-3"></div>
                        </div>
                    </div>
                    <div class="colissimo-key-field">
                        <div class="alert alert-info">
                            {l s='Please, fill the field "account number" to use the customs document function' mod='colissimo'}
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-3">
                            <span>
                             {l s='Account key' mod='colissimo'}
                            </span>
                            </label>
                            <div class="col-lg-9">
                                <div class="input-group fixed-width-xxl">
                                    <span class="input-group-addon"><i class="icon-user"></i></span>
                                    <input type="text"
                                           name="COLISSIMO_ACCOUNT_KEY"
                                           class="input fixed-width-xxl"
                                           value="{$form_data['COLISSIMO_ACCOUNT_KEY']|escape:'htmlall':'UTF-8'}">
                                </div>
                            </div>
                            <div class="col-lg-9 col-lg-offset-3"></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group fixed-width-xxl">
                                    <span class="input-group-addon"><i class="icon-user"></i></span>
                                    <input type="text"
                                           name="COLISSIMO_ACCOUNT_CONTRACT_NUMBER"
                                           class="input fixed-width-xxl"
                                           value="{$form_data['COLISSIMO_ACCOUNT_CONTRACT_NUMBER']|escape:'htmlall':'UTF-8'}">
                                </div>
                            </div>
                            <div class="col-lg-9 col-lg-offset-3"></div>
                        </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="checkbox child">
                                <label>
                                    <input type="checkbox"
                                           name="COLISSIMO_ACCOUNT_TYPE[][]"
                                           {if isset($form_data['COLISSIMO_ACCOUNT_TYPE']['ECOOM'])}checked="true"{/if}
                                           value="ECOOM">
                                    {l s='Eco Overseas' mod='colissimo'}
                                </label>
                                <p class="help-block">
                                    {l s='Offer available only for customers who drop off or collect directly from Colissimo platforms. Do not hesitate to contact your sales representative for more information.' mod='colissimo'}
                                </p>
                            </div>
                            <div class="checkbox">
                                <label>
                ...
                <div class="panel">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-lg">
                                    ...
                                    <input type="text"
                                           ...
                                           required="required"
                                           value="{if $form_data['sender_company']}{$form_data['sender_company']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-lg">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input fixed-width-lg"
                                           required="required"
                                           value="{if $form_data['sender_lastname']}{$form_data['sender_lastname']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-lg">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input fixed-width-lg"
                                           required="required"
                                           value="{if $form_data['sender_firstname']}{$form_data['sender_firstname']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           required="required"
                                           value="{if $form_data['sender_address1']}{$form_data['sender_address1']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           value="{if $form_data['sender_address2']}{$form_data['sender_address2']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           value="{if $form_data['sender_address3']}{$form_data['sender_address3']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           value="{if $form_data['sender_address4']}{$form_data['sender_address4']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           required="required"
                                           value="{if $form_data['sender_city']}{$form_data['sender_city']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-sm">
                                    <input type="text"
                                           ...
                                           value="{if $form_data['sender_zipcode']}{$form_data['sender_zipcode']|escape:'htmlall':'UTF-8'}{/if}"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-lg-9 col-lg-offset-3"></div>
                        ...
                        <div class="form-group"><label class="control-label col-lg-3 required">
                            ...
                            <div class="col-lg-9">
                                <select id="colissimo-country" name="sender_country" class="cls-chosen fixed-width-xl"
                                        style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"
                                           ...
                                           value="{if $form_data['sender_phone']}{$form_data['sender_phone']|escape:'htmlall':'UTF-8'}{/if}"
                                           required="required">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           required="required"
                                           value="{if $form_data['sender_email']}{$form_data['sender_email']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="80"
                                           maxlength="80">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-lg">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input fixed-width-lg"
                                           required="required"
                                           value="{if $form_data['return_company']}{$form_data['return_company']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-lg">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input fixed-width-lg"
                                           required="required"
                                           value="{if $form_data['return_lastname']}{$form_data['return_lastname']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-lg">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input fixed-width-lg"
                                           required="required"
                                           value="{if $form_data['return_firstname']}{$form_data['return_firstname']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           required="required"
                                           value="{if $form_data['return_address1']}{$form_data['return_address1']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           value="{if $form_data['return_address2']}{$form_data['return_address2']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           value="{if $form_data['return_address3']}{$form_data['return_address3']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           value="{if $form_data['return_address4']}{$form_data['return_address4']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           required="required"
                                           value="{if $form_data['return_city']}{$form_data['return_city']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="35"
                                           maxlength="35">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9">
                                <div class="fixed-width-sm">
                                    <input type="text"
                                           ...
                                           name="return_zipcode"
                                           class="input  fixed-width-sm"
                                           value="{if $form_data['return_zipcode']}{$form_data['return_zipcode']|escape:'htmlall':'UTF-8'}{/if}"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-lg-9 col-lg-offset-3"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text"
                                           ...
                                           class="input fixed-width-xl"
                                           value="{if $form_data['return_phone']}{$form_data['return_phone']|escape:'htmlall':'UTF-8'}{/if}"
                                           required="required">
                                </div>
                            </div>
                            <img src="{$colissimo_img_path|escape:'html':'UTF-8'}icons/icon_valid.png"
                            ...
                            <div class="col-lg-9">
                                <div class="input-group input fixed-width-xxl">
                                    ...
                                    <input type="text"
                                           ...
                                           class="input  fixed-width-xxl"
                                           required="required"
                                           value="{if $form_data['return_email']}{$form_data['return_email']|escape:'htmlall':'UTF-8'}{/if}"
                                           data-maxchar="80"
                                           maxlength="80">
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var colissimoSenderPhone = '{/literal}{if $form_data['sender_country']}{$form_data['sender_country']|escape:'htmlall':'UTF-8'}{/if}{literal}';
    var colissimoReturnPhone = '{/literal}{if $form_data['return_country']}{$form_data['return_country']|escape:'htmlall':'UTF-8'}{/if}{literal}';
    var onlyCountries = {/literal}{array_keys($address_countries)|json_encode}{literal};
