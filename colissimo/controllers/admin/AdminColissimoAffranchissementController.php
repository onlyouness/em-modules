    ...
    public function initStep2($selection)
    {
        ...
        foreach ($ids as $id) {
            ...
            $data[$id] = [
                ...
                'order_blocking_code' => (float)$order->total_paid_tax_incl < (float)Configuration::get('COLISSIMO_BLOCKING_CODE_TOTAL_MAX'),
            ];
        ...
        if ($this->module->checkColissimoBlockingCode() &&
            $colissimoService->type == ColissimoService::TYPE_SIGN &&
            $isoCustomerAddr == 'FR'
        ) {
            $this->context->smarty->assign('blocking_code', Configuration::get('COLISSIMO_DELIVERY_BLOCKING_CODE'));
        }
        $this->context->smarty->assign(
            [
                'orders' => $data,
                ...
                'insurance_msg' => $colissimoService->type == ColissimoService::TYPE_RELAIS ? 1 : 0,
                'ecoOm_msg' => $colissimoService->type == ColissimoService::TYPE_ECO_OM ? 1 : 0,
