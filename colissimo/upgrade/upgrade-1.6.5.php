...
function upgrade_module_1_6_5($module)
{
    ...
    $module->logger->info('Module upgrade. Version 1.6.5');
    Db::getInstance()->execute('UPDATE `' . _DB_PREFIX_ . 'colissimo_service` SET `product_code`= "DOS" WHERE commercial_name = "INT - DOMICILE avec signature"');
