...
/**
 * Class ColissimoCreateCustomDocumentResponse
 */
class ColissimoCreateCustomDocumentResponse extends AbstractColissimoResponse implements ColissimoReturnedResponseInterface
{
    /** @var string */
    public $errorCode;
