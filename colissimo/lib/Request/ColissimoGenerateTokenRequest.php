...
/**
 * Class ColissimoGenerateTokenRequest
 */
class ColissimoGenerateTokenRequest extends ColissimoGenerateLabelRequest
{
    const WS_TYPE = 'CURL';
    const WS_PATH = '/sls-ws/SlsServiceWSRest/2.0/generateToken?';
