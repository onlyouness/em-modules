...
/**
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Hp\Regimebanner\Repository\BannerRepository")
...
class RegimeBanner
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Hp\Regimebanner\Entity\RegimeBannerLang", cascade={"persist", "remove"}, mappedBy="banner")
     */
    private $bannerLangs;
    ...
    public function addBannerLang(RegimeBannerLang $bannerLang): self
    {
