...
namespace Hp\Nosatouts\Form\Provider;

use DbQuery;
use Hp\Nosatouts\Repository\AtoutRepository;
use PrestaShop\PrestaShop\Core\Form\IdentifiableObject\DataProvider\FormDataProviderInterface;

class AtoutDataProvider implements FormDataProviderInterface
{
    /**
     * @var AtoutRepository
     */
    ...
    /**
     * @param AtoutRepository $repository
     */
    public function __construct(AtoutRepository $repository)
    {
    ...
    public function getData($id)
    {
        ...
        if ($atout) {
            ...
            foreach ($languages as $index => $language) {
                $groupLang = $this->getAtoutLangs($atout->getId());
                if ($groupLang) {
