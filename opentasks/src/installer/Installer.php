...
class Installer
{
    private $tabs=[
        ...
        'class_name'=> 'AdminOpenTask',
        'name'=> 'Open Tasks',
        'icon' => '',
        'wording'=>'Gestion des Task',
        'wording_domain'=> 'Modules.OpenTasks.Admin'
    ]
    ];
    ...
    protected function installTab(Module $module) :bool
    {
        ...
        $parentTabClassName = 'AdminTasks'; // Unique class name for parent tab
        if (!Tab::getIdFromClassName($parentTabClassName)) {
            ...
            foreach ($languages as $language) {
                $parentTab->name[$language['id_lang']] = 'Tasks Manager'; // Display name for parent tab
            }

            $parentTab->icon = 'settings'; // Optional icon for the parent tab
            $parentTab->wording = 'Tasks Manager';
            $parentTab->wording_domain = 'Modules.OpenTasks.Admin';
