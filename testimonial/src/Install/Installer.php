...
class Installer
{
    ...
    private $tabs = [
        [
            'class_name' => 'AdminTestomonial',
            'name' => 'Testomonial',
            'icon' => '',
            'wording' => 'Manager Testomonial',
            'wording_domain' => 'Modules.Testomonial.Admin'
        ]
    ];
    ...
    {
        $parentTabId = Tab::getIdFromClassName('AdminParentCustomer');

        if (!$parentTabId) {
            PrestaShopLogger::addLog('Parent tab AdminParentCustomer does not exist.', 3);
            return false;
        }
