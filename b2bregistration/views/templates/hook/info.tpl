...
<div class="panel" id="fmm_promo_panel">
  ...
  <div class="col-lg-7 fmm_promo_modules">
    <ol>
      ...
      <li><a href="https://addons.prestashop.com/en/url-redirects/16633-pretty-urls-remove-ids-numbers-for-seo-friendly-url.html" target="_blank" title="Pretty URLs"><img src="{$smarty.const.__PS_BASE_URI__|escape:'htmlall':'UTF-8'}modules/b2bregistration/views/img/prettyurl.png" alt="" /><i>Pretty URLs Module</i></a></li>
      <li><a href="https://addons.prestashop.com/en/seo-natural-search-engine-optimization/17273-seo-optimizer-add-meta-sitemap-robots-url-redirect.html" target="_blank" title="Advance SEO"><img src="{$smarty.const.__PS_BASE_URI__|escape:'htmlall':'UTF-8'}modules/b2bregistration/views/img/advanceseo.png" alt="" /><i>Advance SEO Module</i></a></li>
      <li><a href="https://addons.prestashop.com/en/registration-ordering-process/19294-registration-fields-add-custom-fields-attributes.html" target="_blank" title="Registration Fields"><img src="{$smarty.const.__PS_BASE_URI__|escape:'htmlall':'UTF-8'}modules/b2bregistration/views/img/registrationfields.png" alt="" /><i>Registration Fields Module</i></a></li>
    </ol>
  </div>
