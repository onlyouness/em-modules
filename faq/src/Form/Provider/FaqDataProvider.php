...
namespace Hp\Faq\Form\Provider;

use PrestaShop\PrestaShop\Core\Form\IdentifiableObject\DataProvider\FormDataProviderInterface;
use Hp\Faq\Repository\FaqRepository;

class FaqDataProvider implements FormDataProviderInterface
{
    /**
     * @var FaqRepository
     */
    ...
    /**
     * Get data for a specific FAQ.
     * This is used for editing an existing FAQ.
     *
     * @param int $faqId
     * @return array
     */
