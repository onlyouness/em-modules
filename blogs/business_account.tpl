...
{block name='page_content'}
	...
	<section class="register-form">
		...
		<p class="b2b-p">{l s='Already have an account? ' mod='b2bregistration'}
			<a
				href="{$urls.pages.authentication|escape:'htmlall':'UTF-8'}">{l s='Log in instead!' d='Shop.Theme.Customeraccount'}</a>
		</p>

		<form id="customer-form" class="form-empty" enctype="multipart/form-data" method="post" action="{$url_link|escape:'htmlall':'UTF-8'}">
			...
			<section>
				...
				{if $enable_address}
					...
					<div class="form-group col-md-3">
						...
						<input type="text" name="address_alias" id="address-alias"
							placeholder="{l s='e.g Home' mod='b2bregistration'}" class="form-control" value="Home">
					</div>

					<div class="form-group col-md-3">
						<label for="id_country">{l s='Ville' mod='b2bregistration'}{if $required_country}<sup
				...
				{if $enable_group_selection}
					{if !empty($selected_groups)}
						<div class="form-group col-md-4">
							<label for="select-group">{l s='Sélectionner votre groupe' mod='b2bregistration'}</label>
				...
				<div class="form-group row ">
					...
					<div class="col-md-6">
						<input class="form-control"  name="b2b_file_1" type="file">
					</div>
				</div>
				...
				<div class="form-group row ">
					...
					<div class="col-md-6">
						<input class="form-control"  name="b2b_file_2" type="file">
					</div>
				</div>

				<div class="form-group row ">
					<label class="col-md-3 form-control-label">
						Spécimen de chèque bancaire
					</label>
					<div class="col-md-6">
						<input class="form-control"  name="b2b_file_3" type="file">
					</div>
				</div>
				<div class="form-group row ">
					<label class="col-md-3 form-control-label">
						Copie de la piéce d'identité
					</label>
					<div class="col-md-6">
						<input class="form-control"  name="b2b_file_4" type="file">
					</div>
				</div>
				<div class="form-group row ">
					<label class="col-md-3 form-control-label">
						Bulletin d'identification fiscale (DGI)
					</label>
					<div class="col-md-6">
						<input class="form-control" name="b2b_file_5" type="file">
					</div>
				</div>
				<div class="file_info">
