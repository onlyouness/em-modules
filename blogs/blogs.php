...

{
    ...
    public function installDb()
    {
        ...
        $queries = [];
        $queries[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'blogs` (
        ...
        $queries[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'blog_paragraph` (
            `id` INT AUTO_INCREMENT PRIMARY KEY,
        ...
        $queries[] = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'blog_sections` (
            `id` INT AUTO_INCREMENT PRIMARY KEY,
    ...
    public function uninstallDb()
    {
        ...
        $queries[]= 'DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'blogs`';
        $queries[]= 'DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'blog_paragraph`';
        $queries[]= 'DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'blog_sections`';
